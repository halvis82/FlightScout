...
def warm(currency: str = typer.Option("USD"), verbose: bool = typer.Option(False, "-v")):
    """Pre-compute explore results for everyone's home airports (Google
    Explore in a real browser + Kiwi) and store them in the web app's shared
